...
CREATE TABLE TB_TIME (
    ID_TIME INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE TB_PLAYOFF (
    ID_PLAYOFF INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE TB_GRUPO_VINCULO (
    ID_GRUPO_VINCULO INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	ID_GRUPO INT NOT NULL,
